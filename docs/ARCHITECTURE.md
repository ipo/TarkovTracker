...
| `NUXT_PUBLIC_STATIC_QUEST_MODE`                  | Enable static exporter hydration (`public.staticQuestMode`)  | No       |
| `NUXT_PUBLIC_STATIC_QUEST_DATA_BASE_URL`         | Base URL for exporter JSON (`public.staticQuestDataBaseUrl`) | No       |
